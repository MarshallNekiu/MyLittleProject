...
@export var guideline_color: Color = Color(0.25, 0.25, 0.25, 1)
@export var guideline_active_color: Color = Color(0, 0, 0, 1)
...
@export var guideline_y_offset: float = 0 # Used for draw guidelines a bit upper
